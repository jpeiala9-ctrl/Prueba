...
// Versión: 5.19 - Carga instantánea sin pantalla negra.
// ====================
...
const Auth = {
  ...
  async _cargarDatosYMostrarApp(uid, email, userData) {
    ...
    // 4. El resto de datos (perfil, gamificación, mensajes) se cargan en background
    Promise.allSettled([
    ...
    // 5. Actualizar elementos UI inmediatos (con datos ya disponibles en AppState)
    ...
    Utils.hideLoading();
    console.log('✅ App mostrada instantáneamente.');
  },

  // ... el resto del código (registerUser, loginUser, etc.) permanece igual ...
  async registerUser() {
