...
const Sponsors = {
  ...
  _tarjetaAdminHTML(sp, colorNivelAdmin) {
    ...
    return `
      <div style="background:${activo ? colorNivelAdmin + '33' : 'var(--bg-secondary)'}; border:${activo ? '2px' : '1px'} solid ${activo ? colorNivelAdmin : 'var(--border-color)'}; border-radius:16px; padding:14px; margin-bottom:10px; transition:background 0.2s ease, border-color 0.2s ease;">
...
console.log('✅ sponsors.js v1.10 - Panel admin: tarjeta con el mismo aspecto que el Dashboard (imagen+etiqueta+descripción+descuento), imagen=activar/desactivar con color de nivel, botones EDITAR/ELIMINAR');