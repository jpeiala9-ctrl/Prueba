...
// Versión: 2.9 - Bump de caché (v83 -> v84) tras: arreglado el error de
//                carga en "buscar usuarios" (faltaba declarar badgeStyle
//                en esa lista tras una limpieza anterior), quitado el
//                texto "Toca para ver..." de la tarjeta de carga/
//                recuperación del dashboard (la tarjeta entera ya es
//                pulsable), y el nombre en las solicitudes de amistad
//                enviadas/recibidas ahora se pinta del color de nivel de
//                cada usuario (igual que la bolita).
...
self.addEventListener('install', event => {
  console.log('[SW] Instalando RI5 v84...');
  event.waitUntil(
