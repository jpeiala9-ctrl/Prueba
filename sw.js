...
// Versión: 2.112 - Bump de caché (v251 -> v252): app.js — la papelera de
//                 cada tarjeta de soporte se queda corta de espacio: con
//                 tan poco margen inferior quedaba casi a la misma altura
//                 que el texto y se veía centrada. Ahora la tarjeta tiene
//                 más aire debajo del contenido para que la papelera caiga
//                 claramente en su propia esquina inferior derecha.
// =====================================================================

const CACHE_NAME = 'ri5-v252';
