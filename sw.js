...
// Versión: 2.12 - Bump de caché (v86 -> v87) por cambios en index.html
//                (tarjeta "Carga y recuperación": % en vivo con
//                auto-refresco), gps-tracker.js (cancelar() ahora
//                resetea isRunning/watchId/intervalos por completo) y
//                gamification.js (racha, madrugador, días de la semana,
//                racha de meses y distancia máxima ahora se recalculan
//                desde el historial real al desmarcar/borrar una sesión,
//                en vez de quedarse "pegados" arriba para siempre).
...
self.addEventListener('install', event => {
  console.log('[SW] Instalando RI5 v87...');
  event.waitUntil(
