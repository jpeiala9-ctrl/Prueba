...
// Versión: 2.11 - Bump de caché (v85 -> v86) por cambios en index.html
//                (tarjeta "Carga y recuperación": % en vivo con
//                auto-refresco) y gps-tracker.js (cancelar() ahora
//                resetea isRunning/watchId/intervalos por completo).
...
self.addEventListener('install', event => {
  console.log('[SW] Instalando RI5 v86...');
  event.waitUntil(
