...
// Versión: 2.2 - Bump de caché (v71 -> v72) tras los cambios de UI:
//                login sin icono circular, "RI5" en todas las pestañas
//                coloreado por nivel, píldora premium eliminada del
//                dashboard, colores de nivel en escala de 10 tonos,
//                nombre de plan editable pulsando el texto, y ajustes
//                de espaciado en login/dashboard/registro.
...
self.addEventListener('install', event => {
  console.log('[SW] Instalando RI5 v72...');
  event.waitUntil(
