...
// Versión: 2.6 - Bump de caché (v80 -> v81) tras: recentrado GPS reforzado
//                en cambios de orientación (doble pasada + Screen
//                Orientation API), tarjeta de usuario en buscar/amigos
//                igual que el pasaporte real (borde y nombre del color de
//                su nivel, sin botón de cambiar zapatilla) y sin la
//                etiqueta redundante "(Nv. X)" junto al nombre, reversión
//                completa de la gamificación (incluidas las insignias y su
//                XP) al desmarcar o borrar una sesión ya registrada, y los
//                modales de renombrar plan / escribir mensaje o responder
//                desde el panel de admin ahora tienen el mismo estilo que
//                el resto de la app (como el de cambiar zapatilla) en vez
//                de los prompt() nativos del navegador.
...
self.addEventListener('install', event => {
  console.log('[SW] Instalando RI5 v81...');
  event.waitUntil(
