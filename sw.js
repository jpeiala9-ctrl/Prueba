...
// Versión: 2.15 - Bump de caché (v89 -> v90) por app.js: al entrar en la
//                app, Auth.checkSavedSession() estaba escrita para
//                restaurar el dashboard al instante desde caché local pero
//                nunca se llamaba desde ningún sitio -- así que la app
//                dependía solo del listener asíncrono de Firebase, que a
//                veces evaluaba el correo como no verificado un instante
//                y dejaba ver de refilón la pantalla de "verifica tu
//                correo" antes de corregirse sola al dashboard. Ahora se
//                llama al arrancar, así que lo primero que se ve es
//                directamente el dashboard.
...
self.addEventListener('install', event => {
  console.log('[SW] Instalando RI5 v90...');
  event.waitUntil(
