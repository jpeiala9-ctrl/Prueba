...
// Versión: 2.3 - Bump de caché (v77 -> v78) tras el cambio en storage.js
//                y app.js: sincronización automática de la foto de perfil
//                en las publicaciones antiguas del muro y en los chats
//                (antes se quedaban con el emoji tras cambiar la foto).
...
self.addEventListener('install', event => {
  console.log('[SW] Instalando RI5 v78...');
  event.waitUntil(
