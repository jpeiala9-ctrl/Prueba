...
// Versión: 2.10 - Bump de caché (v84 -> v85). Preparado el terreno para
//                un futuro sistema de "novedades de la versión": el SW
//                notifica a los clientes cuando hay una versión nueva
//                instalada y en espera (ver mensaje 'RI5_NEW_VERSION'
//                más abajo), listo para que app.js muestre un modal de
//                cambios la primera vez que el usuario entra tras
//                actualizar.
...
self.addEventListener('install', event => {
  console.log('[SW] Instalando RI5 v85...');
  event.waitUntil(
