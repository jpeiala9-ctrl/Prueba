...
// Versión: 2.1 - Bump de caché (v55 -> v56) tras añadir el sistema de
//                notificaciones/actualizaciones en tiempo real de amigos
//                en app.js, friends.js y storage.js.
...
self.addEventListener('install', event => {
  console.log('[SW] Instalando RI5 v56...');
  event.waitUntil(
