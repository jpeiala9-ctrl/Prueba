...
// Versión: 2.8 - Bump de caché (v82 -> v83) tras: nueva tarjeta en el
//                Dashboard "Carga y recuperación" (TSS de la última
//                sesión + tiempo de recuperación estimado), que al
//                pulsarla abre un modal con la carga total del plan
//                activo (TSS acumulado, km, sesiones, ACWR/carga
//                aguda-crónica) y una gráfica de TSS por semana.
...
self.addEventListener('install', event => {
  console.log('[SW] Instalando RI5 v83...');
  event.waitUntil(
