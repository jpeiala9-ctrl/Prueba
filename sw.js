...
// Versión: 2.14 - Bump de caché (v88 -> v89) por gps-tracker.js: arreglado
//                que pulsar "CONTINUAR" en el cuadro de "FINALIZAR SESIÓN"
//                dejaba la sesión bloqueada para siempre (el contador del
//                último bloque se quedaba congelado en 00:00 y ni el
//                disparo automático ni el botón "FINALIZAR" volvían a
//                funcionar, sin más salida que recargar la app).
...
self.addEventListener('install', event => {
  console.log('[SW] Instalando RI5 v89...');
  event.waitUntil(
