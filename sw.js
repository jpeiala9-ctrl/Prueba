...
// Versión: 2.110 - Bump de caché (v249 -> v250): index.html (fix de
//                 recargas duplicadas del dashboard al abrir/recargar la
//                 app), app.js y storage.js (panel de soporte admin: la
//                 animación "CARGANDO" ya no se corta, y el botón "VER" de
//                 cada conversación se sustituye por una papelera que la
//                 elimina por completo).
// =====================================================================

const CACHE_NAME = 'ri5-v250';
