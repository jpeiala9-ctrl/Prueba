...
// Versión: 2.4 - Bump de caché (v78 -> v79) tras hacer que las tarjetas
//                pulsables (planes del historial, tarjetas de amigos/
//                solicitudes, caja "Plan" del perfil) respondan al tacto
//                en toda su superficie y no solo en el centro.
...
self.addEventListener('install', event => {
  console.log('[SW] Instalando RI5 v79...');
  event.waitUntil(
