...
// VERSIÓN: 4.44 - Modal de conversación de soporte con estilo consistente
//                (mismos colores, botones y comportamiento que el resto de la app).
// ====================
...
const Admin = {
  ...
  // ============================================================
  // NUEVO SISTEMA DE HILOS DE CONVERSACIÓN DE SOPORTE (VERSIÓN ESTILO CONSISTENTE)
  // ============================================================
  ...
  abrirConversacionSoporte(uid) {
    ...
    `;
    header.innerHTML = `
      <span style="font-size:16px; font-weight:bold; color:var(--accent-yellow);">
        💬 Soporte con <span id="conversacionNombre"></span>
      </span>
      <button onclick="Admin.cerrarConversacionSoporte()" style="
        background:transparent; border:none; font-size:24px; cursor:pointer;
        color:var(--text-secondary); padding:0 8px; line-height:1;
      ">✕</button>
    `;
