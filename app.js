    ...
    return new Promise((resolve) => {
      ...
      modal.innerHTML = `
        ...
        <div style="display: flex; gap: 12px; justify-content: center;">
          <button id="utilsPromptConfirm" style="background: var(--accent-blue); border: none; color: var(--bg-primary); padding: 8px 24px; border-radius: 30px; cursor: pointer;">CONFIRMAR</button>
          <button id="utilsPromptCancel" style="background: transparent; border: 1px solid var(--border-color); color: var(--text-primary); padding: 8px 24px; border-radius: 30px; cursor: pointer;">CANCELAR</button>
        </div>
      `;
