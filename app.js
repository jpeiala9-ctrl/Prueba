...
const AppState = {
  ...
  // activo y no caducado. Se llama al iniciar sesión (setCurrentUser) y
  // también cuando se detecta en segundo plano que el premium acaba de
  // caducar, para refrescarlo al instante sin esperar a recargar la app.
  // Antes buscaba un elemento #ri5Title que ya no existe (se renombró a
  // #appLogoText en el rediseño del login), así que este efecto llevaba
  // tiempo sin aplicarse nunca a nadie.
