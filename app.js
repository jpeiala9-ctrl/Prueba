...
// VERSIÓN: 4.47 - Modal de conversación de soporte con tamaño fijo (min-height: 50vh)
//                 para que no crezca al cargar los mensajes.
// ====================
...
const Admin = {
  ...
  // ============================================================
  // NUEVO MODAL DE CONVERSACIÓN REDISEÑADO (TAMAÑO FIJO DESDE EL INICIO)
  // ============================================================
  ...
  abrirConversacionSoporte(uid) {
    ...
    header.innerHTML = `
      <span style="font-size:16px; font-weight:bold; color:var(--accent-yellow); text-align:center;">
        💬 Soporte con <span id="conversacionNombre"></span>
      </span>
    `;
    ...
    messagesContainer.style.cssText = `
      ...
      min-height:0;
    `;
    // Mostrar un mensaje de carga inicial para ocupar espacio
    messagesContainer.innerHTML = '<p style="text-align:center; color:var(--text-secondary); padding:20px;">Cargando mensajes...</p>';
    ...
    // Cargar mensajes (asíncrono, pero el contenedor ya tiene altura)
