// ==================== calendar.js - VERSIÓN COMPLETA ====================
// Versión: 2.53 - Scroll centrado al cargar plan
// ============================================================================
...
const PlanGenerator = {
  ...
  async generarCalendarioEntreno() {
    ...
    try {
      ...
      // NUEVO: Scroll centrado
      setTimeout(() => {
        if (window.UI && window.UI.scrollToPlanCenter) {
          window.UI.scrollToPlanCenter();
        } else {
...
console.log('✅ PlanGenerator v2.53 - Scroll centrado al cargar plan');