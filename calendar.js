...
// Versión: 2.51 - Scroll al cargar plan desde historial
// ============================================================================
...
const PlanGenerator = {
  ...
  async mostrarUltimoPlanGuardado() {
    ...
    try {
      ...
      // NUEVO: Scroll al calendario
      setTimeout(() => {
        Utils.scrollToElement('calendarioEntreno', -30);
      }, 300);
...
console.log('✅ PlanGenerator v2.51 - Scroll al cargar plan desde historial');