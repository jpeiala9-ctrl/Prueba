...
const Training = {
  ...
  async _generarTarjetaImagen() {
    ...
    // Foto de perfil + color de nivel del usuario actual. Si algo falla
    // (sin conexión, sin datos aún) se sigue con los valores por defecto
    // en vez de romper la generación de la tarjeta.
    let photoURL = null;
    let colorNivel = GOLD;
    try {
      ...
      console.warn('No se pudieron cargar foto/nivel para la tarjeta:', e);
    }
