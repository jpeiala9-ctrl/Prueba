  ...
  async abrirModalRecords() {
    ...
    modal.innerHTML = `
      ...
      <div style="display:flex; justify-content:center; margin-top:20px;">
        <button id="closeRecordsModalBtn" style="background:transparent; border:1px solid var(--border-color); color:var(--text-primary); padding:8px 24px; border-radius:30px; cursor:pointer;">CERRAR</button>
      </div>
    `;
